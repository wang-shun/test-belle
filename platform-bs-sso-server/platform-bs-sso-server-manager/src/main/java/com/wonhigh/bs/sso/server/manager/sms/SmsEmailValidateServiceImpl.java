...
public class SmsEmailValidateServiceImpl implements SmsEmailValidateService{
    ...
    public boolean isSendEmailAram(){
        if("on".equalsIgnoreCase(this.sendEmailSwitch)){
            return true;
        }else if("off".equalsIgnoreCase(this.sendEmailSwitch)){
            return false;
        }
        return false;
    }
    ...
    public boolean isSendSmsAram(){
        if("on".equalsIgnoreCase(this.sendSmsSwitch)){
            return true;
        }else if("off".equalsIgnoreCase(sendSmsSwitch)){
            return false;
        }
        return false;
    }
