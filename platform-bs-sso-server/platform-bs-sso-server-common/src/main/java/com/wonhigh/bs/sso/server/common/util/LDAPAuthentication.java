...
public class LDAPAuthentication {
	 private final String URL = "ldap://localhost:10389/";
	    private final String BASEDN = "dc=wonhigh,dc=com";  // 根据自己情况进行修改
	    ...
	    private String getUserDN(String uid) {
	        ...
	        try {
	            ...
	            NamingEnumeration<SearchResult> en = 
	            		ctx.search("dc=wonhigh,dc=com", "cn=" + uid, constraints);
	    ...
	    public static void main(String[] args) {
	        ...
	        /*if(ldap.authenricate("1004", "123") == true){
	            System.out.println( "该用户认证成功" );
	        }*/
	        
	        String userDN = ldap.getUserDN("oa-u1");
