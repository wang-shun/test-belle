...
if (needCLodop()) {
	...
	oscript.src ="//127.0.0.1:8443/CLodopfuncs.js?priority=1";
	head.insertBefore(oscript,head.firstChild );
	
	//引用双端口(8000和18000）避免其中某个被占用：
	oscript = document.createElement("script");
	oscript.src ="//127.0.0.1:8000/CLodopfuncs.js?priority=0";
	head.insertBefore( oscript,head.firstChild );
};
...
function getLodop(oOBJECT,oEMBED){
    ...
    var strCLodopInstall="<br><font color='#FF00FF'>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href='../lodop/CLodop_Setup_for_Win32NT_https_3.025Extend.exe' target='_self'>执行安装</a>,安装后请刷新页面。</font>";
    var strCLodopUpdate="<br><font color='#FF00FF'>CLodop云打印服务需升级!点击这里<a href='../lodop/CLodop_Setup_for_Win32NT_https_3.025Extend.exe' target='_self'>执行升级</a>,升级后请刷新页面。</font>";
    var LODOP;
    try{
		...
		LODOP.SET_LICENSES("THIRD LICENSE", "", "New Belle footwear (Shenzhen) Co., Ltd.",
