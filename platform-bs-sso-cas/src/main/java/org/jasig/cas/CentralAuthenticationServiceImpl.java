...
public final class CentralAuthenticationServiceImpl implements CentralAuthenticationService {
    ...
    /**
     * @throws CustomAccountLockedException 
    ...
    public String grantServiceTicket(
            ...
            throws AuthenticationException, TicketException, CustomAccountLockedException {
    ...
    public String grantServiceTicket(final String ticketGrantingTicketId,
        final Service service) throws TicketException, CustomAccountLockedException {
        try {
     ...
     */
    @Audit(
			action = "TICKET_GRANTING_TICKET", actionResolverName = "CREATE_TICKET_GRANTING_TICKET_RESOLVER", resourceResolverName = "CREATE_TICKET_GRANTING_TICKET_RESOURCE_RESOLVER")
